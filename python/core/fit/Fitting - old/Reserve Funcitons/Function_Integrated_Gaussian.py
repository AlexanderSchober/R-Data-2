...
class IntGauss:
    ...
    def __init__(self,FitData, Info):
        ...
        self.ParametersIni  = [0,0,0,0]
        self.ParametersFix  = [0,0,0,0]
    ...
    def GaussPart(self,Var,x,Parameters):
        '''
        ##########################################################
