...
class ArctanExpInfo:
    ...
    def __init__(self):
        ...
        self.ParameterProcessing    = ['1',         # <- Number of iteration
                                       '0,1,2,3,4,5'] # <- Order of Processing
...
class ArctanExp:
    ...
    def Function(self,Parameters):
        ...
        #function parameters
        Position_1  = Parameters[1]
        Factor      = Parameters[2]
        Amplitude   = Parameters[3]
        Offset      = Parameters[4]
        Decay       = Parameters[5]
        Position_2  = Parameters[6]
    
        #process the function
        
        
        y           = (((numpy.arctan(( x  - Position_1) * Factor )
                         + numpy.pi / 2) * Amplitude + Offset)
                       * (( numpy.arctan(( x - Position_2) * Decay )
                           + numpy.pi / 2)
                          /numpy.pi )
                       )
